...
__global__ void sumArraysGPU(float *a, float *b, struct naiveStruct *res,
                             int n) {
  // int i=threadIdx.x;
...
void checkResult_struct(float *res_h, struct naiveStruct *res_from_gpu_h,
                        int nElem) {
...
int main(int argc, char **argv) {
  ...
  struct naiveStruct *res_from_gpu_h =
      (struct naiveStruct *)malloc(nByte_struct);
