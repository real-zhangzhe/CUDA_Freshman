...
__constant__ float
    coef[TEMP_RADIO_SIZE]; // if in midle of the program will be error
void convolution(float *in, float *out, float *template_,
...
// read only
__global__ void stencil_1d_readonly(float *in, float *out,
...
int main(int argc, char **argv) {
  ...
  CHECK(cudaMemcpy(dcoef_ro, templ_, TEMP_RADIO_SIZE * sizeof(float),
